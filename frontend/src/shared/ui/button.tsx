  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glass: "glass-button backdrop-blur-md bg-white/10 border border-white/20 text-foreground hover:bg-white/20 hover:shadow-glow",
        floating: "bg-gradient-primary text-white shadow-elegant hover:shadow-glow hover:scale-105 active:scale-95",
        ai: "bg-gradient-to-r from-primary to-accent text-white shadow-glow hover:shadow-xl hover:scale-105 animate-glow-pulse",
      },
      size: {
        default: "h-11 px-5",

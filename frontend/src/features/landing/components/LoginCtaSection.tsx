    ...
    <section ref={sectionRef} className="relative z-10 -mt-24 px-4">
      ...
      >
        <div className="space-y-3">
          <h2 className="text-2xl font-bold md:text-3xl">هل لديك حساب بالفعل؟</h2>
          <p className="text-sm text-slate-600 md:text-base">
            قم بتسجيل الدخول لمتابعة حملتك الانتخابية، توزيع المهام، وقراءة التحليلات في الوقت الفعلي.
          </p>
          <div className="flex flex-wrap gap-3 text-sm text-blue-900/80">
            <span className="flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1">تقارير فورية</span>
            <span className="flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1">خرائط تفاعلية</span>
            <span className="flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1">متابعة ميدانية</span>
          </div>
        </div>

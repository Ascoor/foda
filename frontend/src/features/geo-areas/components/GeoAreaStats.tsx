...
export const GeoAreaStats = ({ area }: Props) => {
  ...
  const stats = [
    {
      label: t("geo_areas.dashboard.voters"),
      value: area.stats.voters,
      icon: Users,
    },
    {
      label: t("geo_areas.dashboard.volunteers"),
      value: area.stats.volunteers,
      icon: UserCheck,
    },
    {
      label: t("geo_areas.dashboard.committees"),
      value: area.stats.committees,
      icon: Building,
    },
  ];

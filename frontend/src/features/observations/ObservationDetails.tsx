    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="glass-card border-white/20 max-w-md">
        ...
        <div className="space-y-2">
          <p>
            <strong>{t("observations.observer")}:</strong>{" "}
            {observation.observer}
          </p>
          {observation.committee_name && (
            <p>
              <strong>{t("observations.committee")}:</strong>{" "}
              {observation.committee_name}
            </p>
          )}
          <p>
            <strong>{t("observations.observation_type")}:</strong>{" "}
            {t(`observations.types.${observation.type}`)}
          </p>
          <p>
            <strong>{t("observations.description")}:</strong>{" "}

...
export const AreaChartCard = () => (
  <GlassCard title="تفاعل الناخبين" description="مقارنة بين نمو القاعدة الجماهيرية ومستوى التفاعل.">
    <div className="h-[260px]">
      <ResponsiveContainer width="100%" height="100%">
        <RechartsAreaChart data={areaData}>
          ...
          <Tooltip contentStyle={{ background: "rgba(15, 23, 42, 0.9)", borderRadius: 16, border: "none", color: "white" }} />
          <defs>
          ...
          <Area type="monotone" dataKey="voters" stroke="#22d3ee" strokeWidth={3} fill="url(#colorVoters)" />
          <Area type="monotone" dataKey="engagement" stroke="#a855f7" strokeWidth={3} fill="url(#colorEngagement)" />
        </RechartsAreaChart>
      </ResponsiveContainer>
    </div>
  </GlassCard>

...
export const SummaryPanel = ({
  ...
  <Card className="h-full bg-gradient-to-br from-[#1C3F60]/92 via-[#1C3F60]/88 to-[#16324d] text-white shadow-xl">
    <CardHeader>
      <CardTitle className="text-2xl font-semibold tracking-tight text-white">{headline}</CardTitle>
    ...
    <CardContent className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border border-white/15 bg-white/5 p-4">
          ...
          <p className="text-2xl font-semibold">{Math.max(remainingValue, 0).toFixed(1)}%</p>
        </div>
      </div>
    </CardContent>
  </Card>

...
- [x] **تحليلات تنبؤية أساسية** مع واجهة `/api/v1/analytics/forecast`
- [x] **محرك تنبيهات ذكي** لمراقبة الأداء والمخاطر الميدانية
- [x] **مركز إشعارات فوري** مع بث لحظي وواجهة استخدام تفاعلية
- [x] **جدولة تلقائية للمهام** لتقارير التحليلات وحملات GOTV وتنظيف المهام الراكدة
...
## 🤖 طبقة الأتمتة الذكية (الإصدار v1.6)

### Smart Alert Engine
- مراقبة تلقائية لهبوط دعم الناخبين اعتمادًا على التوجهات اليومية.
- رصد فوري للبلاغات السلبية خلال 24 ساعة والتصعيد الفوري.
- اكتشاف خمول فرق الميدان لأكثر من 36 ساعة مع توصيات للمتابعة.

### Automation Scheduler
- أوامر مجدولة (`daily:send-analytics-summary`, `weekly:send-gotv-reminders`, `cleanup:stale-assignments`).
- إعدادات قابلة للتخصيص عبر واجهة `/api/v1/automation/config` ولوحة الواجهة الجديدة.
- دعم التشغيل اليدوي والآلي مع تحديث حالات التنفيذ وآخر مرة تشغيل.

### Notification Center
- درج إشعارات تفاعلي مع تصفية (الأداء، الميدان، المخاطر).
- بث فوري عبر Laravel Echo وإشعارات Toast للإنذارات الحرجة.
- إمكانية تعيين الإشعارات كمقروءة فرديًا أو بشكل مجمّع.
